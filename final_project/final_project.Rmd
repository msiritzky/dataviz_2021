...
#It seems like you are doing a pretty repetative process with these columns, and I think it would be possible to use something like lapply or something similar to create a function that you could then use iteratively for each of these variables
